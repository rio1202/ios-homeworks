...
extension ProfileViewController: ProfileTableHeaderViewProtocol {
    ...
    func delegateAction(cell: ProfileTableHeaderView) {
        ...
        let avatarAnimationVC = ImageAnimationViewController()
        self.view.addSubview(avatarAnimationVC.view)
        self.addChild(avatarAnimationVC)
        avatarAnimationVC.view.translatesAutoresizingMaskIntoConstraints = false
        
        NSLayoutConstraint.activate([
            avatarAnimationVC.view.leadingAnchor.constraint(equalTo: view.leadingAnchor),
            avatarAnimationVC.view.trailingAnchor.constraint(equalTo: view.trailingAnchor),
            avatarAnimationVC.view.topAnchor.constraint(equalTo: view.topAnchor),
            avatarAnimationVC.view.bottomAnchor.constraint(equalTo: view.bottomAnchor)
        ])
        
        avatarAnimationVC.didMove(toParent: self)
    }
}
