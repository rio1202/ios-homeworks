...
class PhotosTableViewCell: UITableViewCell {
    ...
    private enum Constant {  // указываем количество ячеек во view
    ...
    private lazy var stackView: UIStackView = {  // Cтек фото
    ...
    private lazy var titleLabel: UILabel = {   // Устанавливаем title у ленты картинок
        let label = UILabel()
        label.text  = "Photos"
    ...
    private lazy var transitionButton: UIButton = {  // Создаем кнопку перехода на tableView
        let button = UIButton()
    ...
    private func itemSize(for width: CGFloat, with spacing: CGFloat) -> CGSize {  // устанавливаем размеры ячейки
...
extension PhotosTableViewCell: UICollectionViewDelegate, UICollectionViewDataSource {
    ...
    func collectionView(_ collectionView: UICollectionView, numberOfItemsInSection section: Int) -> Int {
        ...
        return gameImage.count // задаем количество каритинок во view
    }
